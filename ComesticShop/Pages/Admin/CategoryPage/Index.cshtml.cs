...
namespace ComesticShop.Pages.Admin.CategoryPage
{
    public class IndexModel : PageModel
    {
        ...
        public IndexModel(IAccountRepository accountRepository, ICategoryRepository categoryRepository, ITypeRepository typeRepository)
        {
        ...
        public async Task OnGet()
        {
            ...
            Category = await _categoryRepository.GetCategories();
