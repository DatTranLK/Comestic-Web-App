...
namespace ComesticShop.Pages
{
    public class ProductRecommendModel : PageModel
    {
        ...
        public ProductRecommendModel(ILogger<ProductRecommendModel> logger, IAccountRepository accountRepository, IProductRepository productRepository, ICategoryRepository categoryRepository)
        {
            _logger = logger;
