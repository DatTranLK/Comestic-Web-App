...
namespace ComesticShop.Pages.Salers.OrderPage
{
    public class AcceptModel : PageModel
    {
        ...
        public AcceptModel(IAccountRepository accountRepository, IOrderRepository orderRepository, IOrderDetailRepository orderDetailRepository, ITypeRepository typeRepository, ICategoryRepository categoryRepository)
        {
